...
/**
 * @ORM\Entity(repositoryClass="App\Repository\WebApp\PriceRepository")
...
class Price
{
     ...
     * )
     * @ORM\ManyToOne(targetEntity="App\Entity\WebApp\Availability")
     * @ORM\JoinColumn(name="availability_id", referencedColumnName="id", nullable=false, onDelete="CASCADE")
     */
    private $availability;

    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\WebApp\Appartment", inversedBy="prices")
